...
## [2.3.0](https://github.com/phenixrizen/zen/compare/zen-expression-v2.2.0...zen-expression-v2.3.0) (2026-09-02)
...
## [2.2.0](https://github.com/phenixrizen/zen/compare/zen-expression-v2.1.0...zen-expression-v2.2.0) (2026-08-27)
...
## [2.1.0](https://github.com/phenixrizen/zen/compare/zen-expression-v2.0.1...zen-expression-v2.1.0) (2026-08-27)


### Features

* add date natural language ([#493](https://github.com/phenixrizen/zen/issues/493)) ([1cb74e6](https://github.com/phenixrizen/zen/commit/1cb74e6f59e3a8159dd972506b92bc9954dc9acf))
...
* add trim function to string data type ([#279](https://github.com/phenixrizen/zen/issues/279)) ([49814e1](https://github.com/phenixrizen/zen/commit/49814e1aa0a284675f1c26c2bd403575145354dd))
...
* assignment ([#366](https://github.com/phenixrizen/zen/issues/366)) ([f2fcb95](https://github.com/phenixrizen/zen/commit/f2fcb95ad90fdecf4ff12f8969dc0cf1ed86e6bf))
...
* dates min/max ([#353](https://github.com/phenixrizen/zen/issues/353)) ([34de232](https://github.com/phenixrizen/zen/commit/34de232d3abcc6d81f1993b4e870125c80a6f6e9))
* deserialize variable type ([#256](https://github.com/phenixrizen/zen/issues/256)) ([7b861d0](https://github.com/phenixrizen/zen/commit/7b861d0642bfecd0af927ae072af9560a91f8873))
...
* expression function system ([#340](https://github.com/phenixrizen/zen/issues/340)) ([6535d44](https://github.com/phenixrizen/zen/commit/6535d44e0329138b0df11236a7f042a0a92527df))
...
* function scope alias ([#426](https://github.com/phenixrizen/zen/issues/426)) ([73d5d5c](https://github.com/phenixrizen/zen/commit/73d5d5c6cb7fb2cf87623dc6aaf63eefd774431c))
* fuzzy match ([#168](https://github.com/phenixrizen/zen/issues/168)) ([7ce6ceb](https://github.com/phenixrizen/zen/commit/7ce6ceb9e448e499673ddffd7e0828ceda1a69cc))
...
* implement new functions - part 1 ([#205](https://github.com/phenixrizen/zen/issues/205)) ([e452df3](https://github.com/phenixrizen/zen/commit/e452df33e9c7ef7f5069f9b0a34b8074478e4c35))
...
* interval iterator ([#336](https://github.com/phenixrizen/zen/issues/336)) ([36c3281](https://github.com/phenixrizen/zen/commit/36c32814b8b8b1875b01a2326d44f55b7fc1e814))
* is numeric function; ([#95](https://github.com/phenixrizen/zen/issues/95)) ([807537a](https://github.com/phenixrizen/zen/commit/807537ad77ec04f6efa406994a5166ec8a67afee))
* keys function ([#135](https://github.com/phenixrizen/zen/issues/135)) ([ae68b4a](https://github.com/phenixrizen/zen/commit/ae68b4a0dd81491145d957a6e8282bbce3a3ccde))
* merge function ([#438](https://github.com/phenixrizen/zen/issues/438)) ([53f3b5a](https://github.com/phenixrizen/zen/commit/53f3b5a430a6c1b907e7445acd08a80f9b14214f))
...
* number scientific notation ([#355](https://github.com/phenixrizen/zen/issues/355)) ([29ce060](https://github.com/phenixrizen/zen/commit/29ce060ac78759106fec2db32df6f84a17929723))
* object support ([#226](https://github.com/phenixrizen/zen/issues/226)) ([c9d1e9c](https://github.com/phenixrizen/zen/commit/c9d1e9cc32d50508808f4ae0d1683445518beb30))
...
* template string ([#225](https://github.com/phenixrizen/zen/issues/225)) ([7cb676d](https://github.com/phenixrizen/zen/commit/7cb676d36a05032f85e7554daacb37e7ae2f4026))
* trunc function and decimal places for round (optional) ([#349](https://github.com/phenixrizen/zen/issues/349)) ([d179552](https://github.com/phenixrizen/zen/commit/d179552b3ca521cd7bc91d000218bd65bef814b7))
* type conversions; ([#94](https://github.com/phenixrizen/zen/issues/94)) ([7b36527](https://github.com/phenixrizen/zen/commit/7b36527dc7a1f01b5aa1105bad210d948bc78b7b))
* upgrade dependencies ([#240](https://github.com/phenixrizen/zen/issues/240)) ([719d43a](https://github.com/phenixrizen/zen/commit/719d43a26d59ba9d6667171a71359294aea21c20))
...
* add operator typecheck ([#250](https://github.com/phenixrizen/zen/issues/250)) ([9d0ef40](https://github.com/phenixrizen/zen/commit/9d0ef4060b5fd8ee6d58a2f4c4224e6439865719))
* align date diff with dayjs ([#360](https://github.com/phenixrizen/zen/issues/360)) ([a911a62](https://github.com/phenixrizen/zen/commit/a911a623cbc119ae6a62ef6797c32d94df256e94))
* correctly throw an error when closed bracket is missing in function call ([#337](https://github.com/phenixrizen/zen/issues/337)) ([f81d118](https://github.com/phenixrizen/zen/commit/f81d1188f6f55af4893b88e30bc6861a04f95df6))
* date endOf for a year and isAfter comparison for units ([#348](https://github.com/phenixrizen/zen/issues/348)) ([6027f5a](https://github.com/phenixrizen/zen/commit/6027f5a6a15d1a224f75c69113379bba1a6bc0b2))
* date fn type ([#245](https://github.com/phenixrizen/zen/issues/245)) ([9fba1ff](https://github.com/phenixrizen/zen/commit/9fba1ff7be54e64aa2c195d03d09363979f5b762))
* date method signature ([#351](https://github.com/phenixrizen/zen/issues/351)) ([e09f2ed](https://github.com/phenixrizen/zen/commit/e09f2ede5e41dad018810cdd2266895c1150c050))
...
* empty object ([#241](https://github.com/phenixrizen/zen/issues/241)) ([a903982](https://github.com/phenixrizen/zen/commit/a903982e17812b361a77555597c506bb20657f5f))
* end of week boundary ([#508](https://github.com/phenixrizen/zen/issues/508)) ([32f7fb8](https://github.com/phenixrizen/zen/commit/32f7fb875c53f86129231a875bb14bd801df0bfc))
* **expression:** honour TZ when resolving the local timezone ([cdbd723](https://github.com/phenixrizen/zen/commit/cdbd72321aa5276060276ab2cc2ed5a062cc1493))
* **expression:** honour TZ when resolving the local timezone ([6c605cb](https://github.com/phenixrizen/zen/commit/6c605cb8bed898873c491552555566748c12fe00))
...
* improve type errors ([#259](https://github.com/phenixrizen/zen/issues/259)) ([5a37ef3](https://github.com/phenixrizen/zen/commit/5a37ef319d092c37d6823d95218715383ccee60c))
* lossy exponent fallback ([#352](https://github.com/phenixrizen/zen/issues/352)) ([157859c](https://github.com/phenixrizen/zen/commit/157859ca3709b33caa0aca23c83608d293b04a2d))
...
* normalize number during serialization ([#359](https://github.com/phenixrizen/zen/issues/359)) ([c9d11f1](https://github.com/phenixrizen/zen/commit/c9d11f12dd7863a3602059c730adf3eea8f02c93))
* number fn type ([#354](https://github.com/phenixrizen/zen/issues/354)) ([71b949b](https://github.com/phenixrizen/zen/commit/71b949b1e1d173b3b1be25459d88ffc87e679ab0))
...
* number serde ([#248](https://github.com/phenixrizen/zen/issues/248)) ([6c85cbc](https://github.com/phenixrizen/zen/commit/6c85cbc04dc6b34c02e5e705f6793e0db49f7f4f))
* number serialization ([#247](https://github.com/phenixrizen/zen/issues/247)) ([9a87367](https://github.com/phenixrizen/zen/commit/9a873675db72c8dd13499884b18c4dba9f1b9422))
...
* safe division ([#365](https://github.com/phenixrizen/zen/issues/365)) ([bdf51de](https://github.com/phenixrizen/zen/commit/bdf51dec1104b56f202b17084379b8c3d3610ab6))
...
* string slices; remove int variable type; ([#92](https://github.com/phenixrizen/zen/issues/92)) ([615d554](https://github.com/phenixrizen/zen/commit/615d554215357eff8ccbe484cc5add765a8e8aba))
* timezone caching ([#371](https://github.com/phenixrizen/zen/issues/371)) ([09f59e9](https://github.com/phenixrizen/zen/commit/09f59e9bb2c6be6400cffcec199569395ff7e5db))
* unary closure expression ([#301](https://github.com/phenixrizen/zen/issues/301)) ([df2a44f](https://github.com/phenixrizen/zen/commit/df2a44f8b38eee19ffbdf9b59fafd4594680a61e))
* update rounding strategy ([#361](https://github.com/phenixrizen/zen/issues/361)) ([815729a](https://github.com/phenixrizen/zen/commit/815729aca47f275692695203b12576e96e750490))
